...
from s03_encoding import ordinal_encode, one_hot_encode
# from s04_1_feature_engineering import build_polynomials, transform_label, boxcox_on_variables
from s04_1_feature_engineering import build_polynomials, transform_label, treat_skewness
...
def apply_ml_model(data_dict, y_train_set, model, parameters, scoring=None, 
                   encoding='ordinal', treat_collinearity = False, do_build_polynomals=False, do_transform_label=False, 
                   do_treat_skewness=False,
                   imputation=None, scaler=None,
                   smote=False, testing=False, print_pipeline=False):
    '''
    default is: (X_train_set, y_train_set, model, parameters, scoring=None, imputation=None, scaler=None, smote=False, print_pipeline=False)
    '''
    start_time = datetime.now()
    'X_train', 'X_train_oh', 'X_train_oh_nocol', 
